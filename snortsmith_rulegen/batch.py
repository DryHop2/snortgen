    ...
    try:
        ...
        for idx, rule in enumerate(data, 1):
            try:
                ...
                out_path = _resolve(rule.get("outfile"), config, "default_outfile", "rules/local.rules")
                ...
                src_port = _validate_port(_resolve(rule.get("src_prt"), config, "default_src_port", "any"))
